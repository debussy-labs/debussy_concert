...
class IngestionSourceToRawVaultStoragePhrase(
    PhraseBase, PIngestionSourceToRawVaultStoragePhrase
):
    def __init__(
        self, export_data_to_storage_motif: PExportDataToStorageMotif, name=None
    ) -> None:
