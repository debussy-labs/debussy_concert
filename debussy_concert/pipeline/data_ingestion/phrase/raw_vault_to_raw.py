...
from debussy_concert.pipeline.data_ingestion.config.rdbms_data_ingestion import ConfigRdbmsDataIngestion
...
from debussy_concert.core.movement.protocols import PRawVaultStorageToDataWarehouseRawPhrase
...
class RawVaultStorageExternalTableToDataWarehouseRawPhrase(PhraseBase, PRawVaultStorageToDataWarehouseRawPhrase):
    ...
    def setup(self, movement_parameters: RdbmsDataIngestionMovementParameters,
        ...
        self.merge_table_motif.setup(
            main_table_uri=datawarehouse_raw_uri, delta_table_uri=self.raw_vault_external_table_uri)
        return self


class RawVaultStorageLoadToDataWarehouseRawPhrase(PhraseBase, PRawVaultStorageToDataWarehouseRawPhrase):
    def __init__(self,
