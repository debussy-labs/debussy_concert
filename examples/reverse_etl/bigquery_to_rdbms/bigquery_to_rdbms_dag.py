...
from debussy_concert.pipeline.reverse_etl.composition.bigquery_to_rdbms import BigQueryToRdbms
...
composition_file = (
    f"{dags_folder}/examples/reverse_etl/bigquery_to_rdbms/composition.yaml"
)
...
composition = BigQueryToRdbms()
reverse_etl_movement_fn = composition.bigquery_to_rdbms_reverse_etl_movement_builder
