...
from debussy_concert.pipeline.reverse_etl.composition.bigquery_to_storage import ReverseEtlBigQueryToStorageComposition
...
composition_file = (
    f"{dags_folder}/examples/reverse_etl/bigquery_to_storage/composition.yaml"
)
