...
from .core_for_testing import DummyDag, DummyMovementGroup, DummyPhraseGroup, DummyMotifGroup


class WorkflowServiceForTesting(PWorkflowService):
    def motif_group(self, group_id, workflow_dag, phrase_group) -> DummyMotifGroup:
        return DummyMotifGroup(group_id=group_id, workflow_dag=workflow_dag, phrase_group=phrase_group)

    def phrase_group(self, group_id, workflow_dag, movement_group) -> DummyPhraseGroup:
        return DummyPhraseGroup(group_id=group_id, workflow_dag=workflow_dag, movement_group=movement_group)
